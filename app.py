...
<div class="main-header">
    ...
    <p>Tác giả: Vương Thị Mùi - Trường Tiểu học Đông An - ĐT: 096 2851 008</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vương Thị Mùi - Trường Tiểu học Đông An - ĐT: 096 2851 008</div>", unsafe_allow_html=True)
